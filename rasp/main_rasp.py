...
def ivixDATA():
    #创建CSV文件
    csvfile = open('/home/pi/Desktop/ivix/options.csv', 'a', newline='',encoding='GBK')
...
def getTradeDay():
    csvfile = open('/home/pi/Desktop/ivix/tradeday.csv', 'a', newline='')
    writer = csv.writer(csvfile)
...
def shibor():
    ...
    print(formatDate)
    csvfile = open('/home/pi/Desktop/ivix/shibor.csv', 'a') #newline=''
    writer = csv.writer(csvfile)
...
def optionDATA():
    #创建CSV文件
    csvfile = open('/home/pi/Desktop/ivix/optionsDATA.csv', 'a', newline='',encoding='GBK')
    writer = csv.writer(csvfile)
